...
probPREx<-function(x,n,xnew,m,a1,a2)	#x,n:Data - success,trials,xnew,m:Future - success,trials, a1,a2:Prior parameters
{
  ...
  if ((class(x) != "integer") & (class(x) != "numeric") || length(x) >1|| x<0 ) stop("'x' has to be greater or equal to 0")
  if ((class(n) != "integer") & (class(n) != "numeric") || length(n) >1|| n<0 ) stop("'n' has to be greater or equal to 0")
  if ((class(xnew) != "integer") & (class(xnew) != "numeric") || length(xnew) >1|| xnew<x ) stop("'n' has to be greater than x")
